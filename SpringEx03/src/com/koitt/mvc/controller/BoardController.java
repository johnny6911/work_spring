...
/*
 * Controller 클래스에 해당하는 클래스에 @Controller 애노테이션(Annotation)을 붙인다
...
public class BoardController {
	 ...
	 * required : value에 해당하는 변수가 필수인지 boolean값으로 설정 true이면 필수로 값을 설정해줌
	 */
	@RequestMapping("/")
	public String getEmployee(
			@RequestParam(value="id", defaultValue="1", required=false) int no,
			Model model) {
