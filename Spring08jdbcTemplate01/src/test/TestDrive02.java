...
public class TestDrive02 {
	...
	public static void main(String[] args) {
		...
		List<Employee> empList = template.query(sql, new MyRowMapper(), 10); // query의 리턴타입은 list
		 ...
		 * 테이블의 정보를 객체에다 저장하기 위해 리절트셋익스트렉터를 이용한것
		 */
