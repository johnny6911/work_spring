...
public class TestDrive {
	public static void main(String[] args) {
		...
		// 2-2. 인터페이스를 사용하지 않고 빈 이름과 클래스 정보로 생성하는 방법
		PersonImpl bean02 = context.getBean("person", PersonImpl.class); //뒤에 파라미터 타입으로 자동으로 형변환을 해줌
		...
		System.out.println(bean01 == bean02);	// == 연산자는 주소값 비교
